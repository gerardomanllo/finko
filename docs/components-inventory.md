...
| **Two-card horizontal carousel** | `PageView` with **viewport fraction** + per-page horizontal inset (gap between cards, peek of sibling); **centered dot** indicators under the chart block | Dashboard |
